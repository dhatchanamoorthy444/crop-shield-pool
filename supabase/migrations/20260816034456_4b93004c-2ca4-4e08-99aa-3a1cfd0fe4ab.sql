...
-- We revoke SELECT from 'authenticated' for tables only accessed via SECURITY DEFINER RPCs or Server Functions.
...
-- 2. Restrict discovery for 'anon' role
...
-- We revoke EXECUTE from PUBLIC/authenticated for internal triggers.
-- These should ONLY be run by the system/service_role.
